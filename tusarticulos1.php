          ...
          <ul class="menu">
            <!-- Menu de usuario -->
                ...
                <form method="post" action="protegida.php">
                  ...
                  <a href="login2.php"><i class="fa fa-server" aria-hidden="true"><img width="20px;" src="./img/iconos/cerrar.png"></i>
...
<div class="menu">
  ...
  <?php
require_once 'lib/electronica.php';
