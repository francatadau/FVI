...
if(isset($_POST["accion"])){
	if ($_POST["accion"]=="actualizar"){
      ...
      move_uploaded_file($tmp_name, $ruta);
 			$resultado=$libritos->actualizarLibros($_POST['nombre'],$_POST['descripcion'],$_POST['precio'],$_POST['etiqueta'],$ruta);

    		if($resultado!=null){
          echo "<br><h3 style=' margin: 5px 15px 14px 26px; color: darkseagreen;'> ✓ Libro actualizado correctamente </h3>";
...
if (empty($_POST)) {
?>
<form class="" action="updateLibros.php" method="post" enctype="multipart/form-data">
