...
if(isset($_POST["accion"])){
	if ($_POST["accion"]=="actualizar"){
      ...
      move_uploaded_file($tmp_name, $ruta);
 			$resultado=$clasecitas->actualizarClases($_POST['nombre'],$_POST['descripcion'],$_POST['precio'],$_POST['etiqueta'],$ruta);

    		if($resultado!=null){
          echo "<br><h3 style=' margin: 5px 15px 14px 26px; color: darkseagreen;'> ✓ Clase actualizada correctamente </h3>";
            	// header('Location: protegida.php');
       		}else{
             	echo "<h2>clase no actualizado</h2></br>";
        	}
   		}
	}
}
if (empty($_POST)) {
?>
<form class="" action="updateClases.php" method="post" enctype="multipart/form-data">
        <h1>ACTUALIZA TU CLASE</h1>
